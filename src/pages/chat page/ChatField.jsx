  ...
  return (
    <>
      {isSignedIn ? (
        // for logged in users
        <div
          className={`${dark ? "prompt-shadow" : ""} m-auto flex w-[95%] overflow-hidden xl:w-[45rem] flex-col rounded-3xl border border-[#595c5f]/50 px-4 py-3 text-[#595c5f] dark:border-[#9a9fa5]/50 dark:text-[#868a8f]`}
        >
          <input
        ...
        // for new users
        <div className="m-auto mt-5 flex w-[95%] items-center overflow-hidden rounded-full border border-[#595c5f]/50 px-2 py-1 text-[#595c5f] xl:w-[45rem] xl:px-4 xl:py-2 dark:border-[#9a9fa5]/50 dark:text-[#868a8f]">
          <div className="group relative">
            <GoPlus className="menu-btns text-3xl text-[#595c5f] xl:text-4xl dark:text-[#868a8f]" />
            <p className="bottom-tooltip">Add files</p>
          </div>

          <input
            placeholder="Ask Century"
            className="flex-1 border-none px-1 text-sm text-[#505050] outline-none placeholder:text-sm placeholder:text-[#595c5f] xl:px-3 xl:text-base xl:placeholder:text-base dark:text-white dark:placeholder:text-[#9a9fa5]"
            type="text"
            name="chat-field"
            id="chat-field"
            value={promptInput}
          ...
          {promptInput.trim().length >= 1 ? (
            <div className="group relative">
              <span
                onClick={() => handleSubmit(promptInput, id)}
                className="menu-btns flex h-7 w-7 items-center justify-center rounded-full p-2 text-[#595c5f] xl:h-9 xl:w-9 dark:text-white"
              >
                <IoSend className="text-3xl xl:text-4xl" />
              </span>
              <p className="bottom-tooltip">Submit</p>
            ...
            <div className="group relative">
              <FaMicrophone className="menu-btns text-3xl text-[#595c5f] xl:text-4xl dark:text-[#868a8f]" />
              <p className="bottom-tooltip">Use microphone</p>
            </div>
          )}
        </div>
