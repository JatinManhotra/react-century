...
const SidebarMoreOptions = ({
  ...
  return (
    <ul
      className={`${toggleSidebarOptions ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"} ${collapsed ? "-right-40" : "right-0"} absolute -top-75 sm:-top-80 cursor-pointer rounded-lg bg-[#f0f4f9] whitespace-nowrap shadow shadow-black/50 transition-opacity duration-100 ease-in dark:bg-[#1b1c1d] dark:text-white`}
    >
      <li className="mt-2 mb-2 flex items-center gap-5 px-6 py-2 text-xs xl:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
        <FaHistory className="text-[1rem] sm:text-lg" /> Activity
      </li>

      <li className="mt-2 mb-2 flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
        <HiOutlineUserPlus className="text-lg sm:text-xl" /> Saved info
      </li>

      <li className="mt-2 mb-2 flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
        <IoExtensionPuzzleOutline className="text-lg sm:text-xl" /> Apps
      </li>

      <li className="mt-2 mb-2 flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
        <IoMdLink className="text-lg sm:text-xl" /> Your public links
      </li>

      {/* dropdown to show on mobile devices */}
      <li onClick={()=>setShowOptions({show:(!showOptions.show), title:"Theme"})} className={`relative block xl:hidden  mt-2 mb-2 px-6 py-1 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]`}>
        <div className="flex items-center gap-5">
          <TbSunMoon className="text-2xl sm:text-3xl" />{" "}
          <p className="flex w-full items-center justify-between">
            Theme <MdArrowRight className="text-lg" />
          </p>
        </div>

        <div className={`${(showOptions.title === "Theme" &&  showOptions.show) ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"} z-[50]  absolute -top-0 -right-30 sm:-right-45  transition-opacity duration-100 ease-in `}>
          <ul className="w-40 sm:w-50 bg-[#f0f4f9] py-2 whitespace-nowrap shadow shadow-black/50 transition-opacity duration-100 ease-in dark:bg-[#1b1c1d] dark:text-white">
            <li className="mb-2 flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
              System
            </li>

            <li
              onClick={setLightMode}
              className="mb-2 flex w-full items-center justify-between gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]"
            >
            ...
            <li
              onClick={setDarkMode}
              className="flex w-full items-center justify-between gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]"
            >
      ...
      <li className="mt-2 mb-2 flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
        <MdOutlineFeedback className="text-lg sm:text-xl" /> Send feedback
      </li>

      {/* dropdown to show on mobile devices */}
      <li onClick={()=>setShowOptions({show:(!showOptions.show), title:"Help"})}  className="group relative block xl:hidden mt-2 mb-2 px-6 py-1 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
        <div className="flex items-center gap-5">
          <MdOutlineHelpCenter className="text-2xl sm:text-3xl" />{" "}
          <p className="flex w-full items-center justify-between">
        ...
        <div className={`${(showOptions.title === "Help" &&  showOptions.show) ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"} absolute -top-5 -right-30 xl:-right-45  transition-opacity duration-100 ease-in `}>
          <ul className="w-40 xl:w-50 bg-[#f0f4f9] py-2 whitespace-nowrap shadow shadow-black/50 transition-opacity duration-100 ease-in dark:bg-[#1b1c1d] dark:text-white">
            <li className="mb-2 flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
              <IoIosHelpCircleOutline className="text-lg sm:text-xl" /> Help center
            </li>

            <li className="flex items-center gap-5 px-6 py-2 text-xs sm:text-sm hover:bg-[#dde3ea] active:bg-[#b5bac0] dark:hover:bg-[#313234] dark:active:bg-[#313234]">
              <MdOutlinePrivacyTip className="text-lg sm:text-xl" />
              Privacy
            </li>
          </ul>
        </div>
