  ...
  return (
    <div className="mt-10 flex flex-col gap-2">
      {!hideSidebar ? (
        ...
        >
          <HiOutlinePencilSquare className="text-lg sm:text-xl" />
          <h3 className="sm:text-base text-sm overflow-hidden">New Chat</h3>
      ...
      {isSignedIn && !hideSidebar && (
        ...
        >
          <FaRegGem className="sm:text-lg" />
          <h3 className="overflow-hidden text-sm sm:text-base">Explore Gems</h3>
